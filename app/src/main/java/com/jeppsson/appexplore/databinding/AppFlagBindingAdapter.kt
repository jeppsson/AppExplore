...
@BindingAdapter("app_flags")
fun appFlags(view: TextView, applicationInfo: ApplicationInfo) {
    view.text = view.context.getString(R.string.app_info_app_flags, applicationInfo.flags,
            getReadableFlags(applicationInfo.flags))
}

private fun getReadableFlags(appFlags: Int): String {
